...
export default function GoogleCalendarConnectionStatus() {
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
        ...
        <span className="text-gray-600 dark:text-gray-300 text-sm">Checking Google Calendar...</span>
      </div>
    );
  }
  ...
  if (status?.connected) {
    return (
      <div className="flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-lg border border-green-200 dark:border-green-800">
        ...
        <span className="text-green-700 dark:text-green-400 text-sm font-medium">Google Calendar Connected</span>
